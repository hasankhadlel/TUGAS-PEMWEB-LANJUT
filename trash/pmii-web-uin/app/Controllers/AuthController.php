        ...
        try {
            ...
            if ($user) {
                ...
                $response->json([
                    ...
                    'user' => [
                        // Mengubah 'username' menjadi 'nim_username' atau 'email'
                        // Tergantung mana yang ingin Anda kirimkan ke frontend sebagai identitas login
                        'username' => $user['nim_username'] ?? $user['email'], // Menggunakan nim_username jika ada, fallback ke email
                        'role' => $user['role']
                    ],
                    'authToken' => $authToken
                ], 200);
