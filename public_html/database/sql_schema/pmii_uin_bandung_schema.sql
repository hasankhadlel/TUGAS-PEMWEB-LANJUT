...
-- Harus dibuat sebelum `users` karena `users` memiliki Foreign Key ke `rayons`.
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Struktur Tabel untuk `password_resets` (Untuk Fitur Lupa Password)
-- Menyimpan token reset password yang bersifat sementara.
-- --------------------------------------------------------
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tabel untuk token reset password';
